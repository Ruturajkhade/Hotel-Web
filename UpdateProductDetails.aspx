<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="UpdateProductDetails.aspx.cs" Inherits="UpdateProductDetails" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource1"
                    DataTextField="CatName" DataValueField="CatID" AutoPostBack="True" OnDataBound="DropDownList2_DataBound">
                </asp:DropDownList>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList3" runat="server" DataSourceID="SqlDataSource2"
                    DataTextField="SubCatName" DataValueField="SubCatID" OnDataBound="DropDownList3_DataBound">
                </asp:DropDownList>
        ...
        <%--<tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownList4" runat="server" DataSourceID="SqlDataSource3"
                    DataTextField="BName" DataValueField="BID" OnDataBound="DropDownList4_DataBound">
                </asp:DropDownList>
