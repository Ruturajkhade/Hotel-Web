<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="UpdateSubcat.aspx.cs" Inherits="UpdateSubcat" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table width="100%">
        ...
        <tr>
            ...
            <td align="left">
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="SubCatID"
                    DataSourceID="SqlDataSource2" Width="420px">
                    <Columns>
                        <asp:ImageField DataImageUrlField="SubCatPic" DataImageUrlFormatString="uploads/{0}"
                            HeaderText="Image">
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="subcatid" DataNavigateUrlFormatString="updatesubcatdetails.aspx?scid={0}"
                            HeaderText="Update" Text="Update" />
                    </Columns>
                </asp:GridView>
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConflictDetection="CompareAllValues"
                    ConnectionString="<%$ ConnectionStrings:MyConnectionString %>" DeleteCommand="DELETE FROM [addsubcat] WHERE [SubCatID] = @original_SubCatID"
                    InsertCommand="INSERT INTO [addsubcat] ([SubCatName], [SubCatPic]) VALUES (@SubCatName, @SubCatPic)"
                    OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT [SubCatName], [SubCatPic], [SubCatID] FROM [addsubcat] WHERE ([CatID] = @CatID)"
        ...
        <tr>
            <td colspan="2">
                <br /><br /><br />
                <asp:Button ID="Button2" runat="server" Text="Back" PostBackUrl="~/Adm_SubCategory.aspx" />
            </td>
        </tr>
    </table>
</asp:Content>
