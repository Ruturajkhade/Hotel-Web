<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AddCat.aspx.cs" Inherits="AddCat" %>
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" Text="Add Category" 
                    onclick="Button1_Click1" /> &emsp;&emsp;
                <asp:Button ID="Button2" runat="server" Text="Back" PostBackUrl="~/Adm_Category.aspx" />
            </td>
        </tr>
        <tr>
            <td class="style6">
