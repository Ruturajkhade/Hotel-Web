<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="AddPicture.aspx.cs" Inherits="AddPicture" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table class="style1">
        ...
        <tr>
            ...
            <td>
                <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Add Picture" />
                &emsp;&emsp;
                <asp:Button ID="Button2" runat="server" Text="Back" PostBackUrl="~/AdminPanel.aspx" />
            </td>
        </tr>
        <tr>
            <td class="style2">
            ...
            <td>
                <asp:Panel ID="Panel1" runat="server">
                    <table class="nav-justified">
                        <tr>
                            <td>
                                <strong>Already added pictures for this product</strong>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="picid"
                                    DataSourceID="SqlDataSource4" Width="235px">
                                    <Columns>
                                        <asp:ImageField DataImageUrlField="pic" DataImageUrlFormatString="uploads/{0}" HeaderText="Picture">
                                ...
                                <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConflictDetection="CompareAllValues"
                                    ConnectionString="<%$ ConnectionStrings:MyConnectionString %>" DeleteCommand="DELETE FROM [addproductpic] WHERE [picid] = @original_picid AND (([pic] = @original_pic) OR ([pic] IS NULL AND @original_pic IS NULL))"
                                    InsertCommand="INSERT INTO [addproductpic] ([pic]) VALUES (@pic)" OldValuesParameterFormatString="original_{0}"
                                    OnSelected="SqlDataSource4_Selected" SelectCommand="SELECT [picid], [pic] FROM [addproductpic] WHERE (([CatID] = @CatID) AND ([SubCatID] = @SubCatID) AND ([PID] = @PID))"
                                    ...
                                    <SelectParameters>
                                        ...
                                        <asp:ControlParameter ControlID="DropDownList2" Name="SubCatID" PropertyName="SelectedValue"
                                            Type="Decimal" />
                                        <asp:ControlParameter ControlID="DropDownList3" Name="PID" PropertyName="SelectedValue"
                                            Type="Decimal" />
                                    </SelectParameters>
                                    <UpdateParameters>
                                        <asp:Parameter Name="pic" Type="String" />
